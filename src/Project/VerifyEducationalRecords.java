...
public class VerifyEducationalRecords {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Navigate to the educational management page
            driver.navigate().to("http://localhost:8080/Orphanage-Management-System/Views/educational_management.php");

            // Wait for the page to load
            wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("body")));

            // Verify the presence of "Existing Educational Records" section
            verifyEducationalRecordsSection(driver, "Existing Educational Records");
    ...
    private static void verifyEducationalRecordsSection(WebDriver driver, String sectionName) {
        try {
            // Locate the text "Existing Educational Records" on the page
            List<WebElement> educationalRecordsElements = driver.findElements(By.xpath("//*[contains(text(), '" + sectionName + "')]"));

            if (!educationalRecordsElements.isEmpty()) {
