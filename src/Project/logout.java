    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (currentUrl.equals(expectedDashboardUrl)) {
                ...
                driver.navigate().to("http://localhost:8080/Orphanage-Management-System/Controllers/logout.php");

                // Verify redirection to the login page after logout
                String expectedLoginUrl = "http://localhost:8080/Orphanage-Management-System/Views/login.php";
